                    ...
                    <div className="p-8">
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <input id="visit-date" type="date" value={selectedDate} onChange={e => setSelectedDate(e.target.value)} className={`w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-400 focus:border-amber-400 ${selectedDate ? 'text-gray-900' : 'text-gray-500'}`} />
                            </div>
                            <div>
